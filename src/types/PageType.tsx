...
type possiblePagesNamesType = "Strona Główna" | "Voucher" | "Sklep" | "Login" | "Dołącz do Gry";
...
const possiblePagesNames = tupleBuilder<possiblePagesNamesType>().add("Strona Główna").add("Voucher").add("Sklep").add("Login").add("Dołącz do Gry").build();
